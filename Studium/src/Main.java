...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (v) {
            ...
            System.out.println("How many ticket you want to reserve:");
            int numberOfReservedTickets = input.nextInt();
            ...
            User user = new User(userName, userPhoneNumber, numberOfReservedTickets, ticket);
            ...
            if ("ok".equals(st)) {
                ...
                System.out.println("Num of reserved tickets = " + user.getNumberOfReversedTickets());
